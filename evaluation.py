...
def encode_vid_support(encoder, data_loader, return_ids=True):
    """Encode all videos and captions loadable by `data_loader`
    """
    # numpy array to keep all the embeddings
    embeddings = None
    ...
    for i, (datas, support_datas, idxs, data_ids) in enumerate(data_loader):
        ...
        # compute the embeddings
        emb = encoder(datas, support_datas, data_ids)
...
def encode_text_support(encoder, data_loader, return_ids=True):
    """Encode all videos and captions loadable by `data_loader`
    """
    # numpy array to keep all the embeddings
    embeddings = None
